...
| [audio_shm_ring.py](audio_shm_ring.py) | SharedMemory ring layout, `RingBufferReader` / writer side for audio spans. |
| [logging_setup.py](logging_setup.py) | Shared loguru setup for master and recorder. |

**Specs:** [mvp-modules/forked_assistant/spec/agent_session_spec.md](../mvp-modules/forked_assistant/spec/agent_session_spec.md), [mvp-modules/forked_assistant/spec/interface_spec.md](../mvp-modules/forked_assistant/spec/interface_spec.md) (shutdown §3).
