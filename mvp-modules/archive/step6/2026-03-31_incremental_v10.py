"""Incremental v10 — Buffer overflow fix.

Base: v9 (clean production script).
Fix: Replace O(n) np.append in audio callback path with O(1) list.append.
     Concatenate only at consumption time (predict / transcribe).
"""
