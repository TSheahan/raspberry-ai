"""Incremental v7 — Class definition order (cluster D).

Same as v6 but with class definitions reordered to match v8:
  D. OpenWakeWordProcessor defined before UtteranceCapturer (was after in v6)

v8 order: OpenWakeWordProcessor -> UtteranceCapturer -> DeepgramSTTProcessor
v6 order: UtteranceCapturer -> OpenWakeWordProcessor -> DeepgramSTTProcessor
"""
...
# --- CHANGE D: OpenWakeWordProcessor defined before UtteranceCapturer (match v8) ---
...
async def main():
    ...
    print("Incremental v7 (v6 + class definition reorder): Listening...")
    ...
    print("Incremental v7 finished cleanly -- process should exit now.")
