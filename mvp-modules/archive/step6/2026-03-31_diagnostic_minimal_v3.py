...
async def shutdown():
    """Clean shutdown — called from main asyncio thread."""
    ...
    print("✅ Diagnostic v3 finished cleanly — process should exit now.")
...
async def main():
    ...
    print("🎤 Minimal diagnostic v3 (clean exit, no traceback): Listening for 'hey jarvis' …")
    print("   After wake word, speak a short sentence then pause.")
    print("   Press Ctrl+C when finished speaking.\n")

    # Main loop waits here until shutdown_event is set by SIGINT
